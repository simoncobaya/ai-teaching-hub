...
> Node.js 是很多 AI 编程工具的"运行环境"。就像手机需要安卓或 iOS 系统才能运行 App，Claude Code 等工具需要 Node.js 才能运行。

---

## 🤔 Node.js 是什么？

**Node.js** 是一个让 JavaScript 在电脑上运行的工具。很多 AI 编程工具（Claude Code、OpenCode 等）都是用 Node.js 开发的，所以需要先安装它。
...
本教程自带了 Node.js 安装包，不用去官网找，下载速度也更快：

1. 下载安装包（任选一种）：
   - 📦 **教程自带**（推荐，速度快）：[node-v24.16.0-x64.msi](./dist/node-v24.16.0-x64.msi)
...
>
> 💡 如果老师把整个教程文件夹拷贝给了你，`dist` 目录里的安装包就在你电脑上，不需要联网下载！
>
...
1. 下载安装包（任选一种）：
   - 📦 **教程自带**（推荐，速度快）：[node-v24.16.0.pkg](./dist/node-v24.16.0.pkg)
   - 🌐 **官网下载**：https://nodejs.org/ 下载 **LTS 版本**
2. 双击 `.pkg` 安装包
3. 一路点击 **"Continue"（继续）**
4. 安装完成！🎉
...
本教程自带了 Linux 版 Node.js 安装包：

```bash
# 1. 解压安装包（先进入 dist 目录所在位置）
...
Node.js 安装好了！现在可以开始安装 AI 编程工具了：

👉 **[安装 Claude Code](../02-claude-code/install.md)** — 安装最强大的 AI 编程助手

👉 **[AI 编程工具全景图](./tool-map.md)** — 看看还有哪些工具可以装
